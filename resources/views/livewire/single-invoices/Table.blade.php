<button class="btn btn-primary pull-right"  wire:click="show_table" type="button">اضافة فاتورة جديدة </button><br><br>
<div class="table-responsive">
    <table class="table text-md-nowrap" id="example1" data-page-length="50"style="text-align: center">
     ...
     @foreach($singleInvoices as $single_invoice)
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" wire:click="delete({{ $single_invoice->id }})"  data-target="#delete_invoice" ><i class="fa fa-trash"></i></button>
                    <button  wire:click="print({{ $single_invoice->id }})" class="btn btn-primary btn-sm"><i class="fas fa-print"></i></button>
                </td>
            </tr>
            @include('livewire.single-invoices.delete')
@endforeach
