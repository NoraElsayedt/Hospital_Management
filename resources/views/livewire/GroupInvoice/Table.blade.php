        ...
        @foreach ($group_invoices as $group_invoice)
            <tr>
                ...
                <td>
                    ...
                    <button wire:click="delete({{ $group_invoice->id }})"  type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_invoice" ><i class="fa fa-trash"></i></button>
            ...
            @include('livewire.GroupInvoice.delete')
        @endforeach
