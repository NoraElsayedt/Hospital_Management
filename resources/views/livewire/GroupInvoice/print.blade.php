                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">فاتوره خدمه </h1>
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                <label class="tx-gray-600">معلومات الفاتوره</label>
                                      <p class="invoice-info-row"><span>تاريخ الفاتوره</span>{{Request::get('invoice_date')}} <span></span></p>
                                <p class="invoice-info-row"><span>الدكتور</span>{{Request::get('doctor_id')}} <span></span></p>
                                <p class="invoice-info-row"><span>القسم</span>{{Request::get('section_id')}} <span></span></p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="tx-right" colspan="2">{{Request::get('price')}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tx-right" colspan="2">
                                        <h4 class="tx-primary tx-bold">{{Request::get('total_with_tax')}}</h4>
