...
<button class="btn btn-primary pull-right" wire:click="show_form_add" type="button"> {{trans('create-group-service.addService')}} </button><br><br>
<div class="table-responsive">
        <table class="table text-md-nowrap" id="example1" data-page-length="50"style="text-align: center">
        <thead>
            <tr>
                <th>#</th>
                <th>{{trans('create-group-service.name_group')}}</th>
                <th>{{trans('create-group-service.total')}} </th>
                <th>{{trans('create-group-service.notes')}}</th>
                <th>{{trans('create-group-service.operation')}}</th>
            </tr>
        </thead>
        <tbody>
