    ...
    <div class="main-sidemenu">
				...
				<li class="side-item side-item-category">{{trans('Dashboard/main-sidebar.Main')}}</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item"  href="{{ route('Doctor_invoice.index') }}">قائمة الكشوفات</a></li>
							<li><a class="slide-item" href="{{ route('completed_invoices') }}">قائمة الكشوفات المكتملة </a></li>
							<li><a class="slide-item"href="{{ route('review_invoices') }}">قائمة المراجعات</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<li><a class="slide-item" href="{{ route('List.patient') }}">قائمة المرضي </a></li>
						  <li><a class="slide-item"  href="{{ route('Chat.patient') }}" >المحادثات الاخيرة</a></li>
