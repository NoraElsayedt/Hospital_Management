<div class="main-sidemenu">
				...
				<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item"  href="{{ route('rayemployee_invoice.index') }}">قائمة الكشوفات</a></li>
							<li><a class="slide-item" href="{{  route('rayemployee_invoice.create')  }}">قائمة الكشوفات المكتملة </a></li>
