<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{trans('Dashboard/main-sidebar.sections')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('section.index') }}">{{trans('Dashboard/main-sidebar.view_all')}}</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('Doctor.index')}}">{{trans('Doctors.view_all')}}</a></li>
							<li><a class="slide-item" href="">Product-Details</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='product-cart') }}">Cart</a></li>
						</ul>
					</li>

					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M4 12c0 4.08 3.06 7.44 7 7.93V4.07C7.05 4.56 4 7.92 4 12z" opacity=".3"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93s3.05-7.44 7-7.93v15.86zm2-15.86c1.03.13 2 .45 2.87.93H13v-.93zM13 7h5.24c.25.31.48.65.68 1H13V7zm0 3h6.74c.08.33.15.66.19 1H13v-1zm0 9.93V19h2.87c-.87.48-1.84.8-2.87.93zM18.24 17H13v-1h5.92c-.2.35-.43.69-.68 1zm1.5-3H13v-1h6.93c-.04.34-.11.67-.19 1z"/></svg><span class="side-menu__label">{{trans('Services.Services')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Service.index') }}">{{trans('Services.Single_service')}}</a></li>
							<li><a class="slide-item" href="{{ route('Add_Service') }}">{{trans('Services.group_services')}}</a></li>
							<li><a class="slide-item" href="{{ route('Insurance.index') }}">{{trans('Services.Insurance')}}</a></li>
							<li><a class="slide-item" href=" #">{{trans('Services.Ambulance_calls')}}</a></li>
							<li><a class="slide-item" href="{{ route('Ambulance.index') }}">{{trans('Services.ambulance')}}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='image-compare') }}">bbbbbbbbbbbbbb</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('ReceiptAccount.index') }}">سند قبض </a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('') }}">Advanced Forms</a></li>
