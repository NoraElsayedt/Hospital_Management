							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu dropdown-notifications">
									<div class="menu-header-content bg-primary text-right">
										...
										<p data-count="{{App\Models\Notification::Notificationcount(auth()->user()->id)->count()}}" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 notif-count">{{App\Models\Notification::Notificationcount(auth()->user()->id)->count()}}</p>
									</div>
                            ...
                            <a class="d-flex p-3 border-bottom" href="#">
                                ...
                                <div class="mr-auto">
                                    <i class="las la-angle-left text-left text-muted"></i>
										...
										@foreach(App\Models\Notification::Notificationcount(auth()->user()->name)->get() as $notifications )
										...
										<a class="d-flex p-3 border-bottom" href="#">
											...
											<div class="mr-3">
												<h5 class="notification-label mb-1">{{$notifications->message}}</h5>
                        ...
                        <a class="dropdown-item" href=""><i class="bx bx-cog"></i>تعديل الملف الشخصي</a>
                            ...
                            <form method="POST" action="{{ route('logout.user') }}">
                                @elseif(auth('admin')->check())
                                    ...
                                    <form method="POST" action="{{ route('logout.lab_employee') }}">
