...
@section('title')
{{trans('Dashboard/main-sidebar.sections')}}
@stop
@section('css')
                                        ...
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($laboratories as $laboratorie)
                                               <tr>
                                                   ...
                                                   <td>{{$laboratorie->Lab_Employee->name ?? 'no' }} </td>
                                                   <td>{{$laboratorie->description_employee ?? 'no'  }} </td>
                                                   <td>
                                                       @if($laboratorie->laboratorie_employee_id !== null)
                                                           <a class="btn btn-primary btn-sm" href="{{route('Laboratory_patient.view',$laboratorie->id)}}" role="button">عرض التحليل</a>
                                                       @endif                                                   </td>
                                               </tr>
                                           @endforeach
                                            </tbody>
