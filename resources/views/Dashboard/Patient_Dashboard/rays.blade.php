                                        ...
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($rays as $ray)
                                               <tr>
                                                   ...
                                                   <td>{{$ray->Ray_Employee->name ?? 'no' }} </td>
                                                   <td>{{$ray->description_employee ?? 'no'  }} </td>
                                                  
                                                   <td>
                                                       @if($ray->ray__employee_id !== null)
                                                       <a class="btn btn-primary btn-sm" href="{{route('Ray_patient.view',$ray->id)}}" role="button">عرض الاشعة</a>
                                                       @endif
                                                   </td>
                                               </tr>
                                           @endforeach
