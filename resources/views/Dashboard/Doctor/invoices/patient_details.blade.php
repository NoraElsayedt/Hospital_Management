...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المريض</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/سجل المريض</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <table class="table table-hover text-md-nowrap text-center">
            ...
            @foreach($patient_rays as $patient_ray)
                <tr>
                    ...
                    <td>{{$patient_ray->Ray_Employee->name ?? 'No Employee' }}</td>
              ...
              @endif
                    ...
                    @if($patient_ray->case == 0)
                        <td>
                            <a  href="#edit_xray_conversion{{$patient_ray->id}}" class="modal-effect btn btn-sm btn-primary" data-effect="effect-scale"  data-toggle="modal" ><i class="fas fa-edit"></i></a>
                            <a   href="#delete_xray_conversion{{$patient_ray->id}}" class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"  data-toggle="modal" ><i class="las la-trash"></i></a>
                            @else
                         </td>
                              <td> 
                            <a  href="{{route('Ray.show',$patient_ray->id)}}" class="modal-effect btn btn-sm btn-warning"  ><i class="fas fa-binoculars"></i></a>
                            </td>
                            @endif
                ...
                @include('Dashboard.Doctor.invoices.delete_xray_conversion')
                ...
                <tr>
                    ...
                    @if($patient_Laboratorie->case == 0)
                            ...
                            <td>
                                ...
                                @else
                                <td>
                                <a href="{{route('Laboratory.show',$patient_Laboratorie->id)}}"   class="modal-effect btn btn-sm btn-warning"><i class="fas fa-binoculars"></i></a>
                            </td>
