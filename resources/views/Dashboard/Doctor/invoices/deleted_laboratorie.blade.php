    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('Laboratory.destroy', $patient_Laboratorie->id) }}" method="post">
                    @method('DELETE')
                    @csrf
                    <div class="row">
                        <div class="col">
                            <p class="h5 text-danger"> هل انت متاكد من حذف بيانات مختبر ؟ </p>
                    ...
                    <button type="button" class="btn btn-secondary"
                        ...
                        <button class="btn btn-success">{{trans('Sections.submit')}}</button>
                    </div>
                </form>
            </div>
        </div>
